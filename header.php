  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="fichier.php">Acceuil <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
       <a class="nav-link"  class="btn btn-info" href="create.php">Ajouter</a>
      </li>
            ...
            <div class="row">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-white">
                    ...
                    <a class="navbar-brand" href="#"></a>
                     <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navig
                        <span class="navbar-toggler-icon"></span>
                    </button>
                ...
                <ul class="navbar-nav link">
                 ...
                 <li class="nav-item">
                    <a class="nav-link" href="fichier.php">liste</a>
                </li>
              <!--  <li class="nav-item">
