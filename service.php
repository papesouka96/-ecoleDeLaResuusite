...
<body>
  ...
  <div class="container-fluid">
    ...
    <div id="carouselExampleControls" class="carousel slide " data-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="image/infirmerie.jpg" class="d-block  " style="width:1799px ;height: 599px;" alt="infirmerie">
        </div>
        <div class="carousel-item">
          <img src="image/transports (1).jpg" class="d-block  " style="width:1799px ;height: 599px;" alt="">
        </div>
        <div class="carousel-item">
          <img src="image/restauration.jpg" class="d-block  " style="width:1799px ;height: 599px;" alt="">
        </div>
      </div>
    ...
    <div class="card-deck">
      <div class="card">
        <img src="image/restauration.jpg" class="card-img-top" alt="...">
      ...
      <div class="card">
        <img src="image/infirmerie.jpg" class="card-img-top" alt="...">
        <div class="card-body" style="background-color:#1E434Eff">
      ...
      <div class="card">
        <img src="image/transports (1).jpg" class="card-img-top" alt="...">
        <div class="card-body" style="background-color:#1E434Eff">
